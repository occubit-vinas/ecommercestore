...
import { S_filter, H_filter, Add, Refresh, Plus_Create } from '@/components/ui/Buttons'
import Serch_bar from '@/components/ui/Serch_bar'
import Filterbar from '@/components/coupon/FilterBar'
    ...
    return (
        ...
        <div className='flex flex-col gap-[32px]'>
            <Header
                ...
                desc="Create and manage discount codes for your stores"
                b4={<Export onClick={() => { }} />}
                ...
                b3={<Plus_Create onClick={handleAddClick} />}
            />
