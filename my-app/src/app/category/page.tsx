...
import { S_filter, Refresh, Add } from '@/components/ui/Buttons';
...
export default function Page() {
    ...
    return (
        ...
        <div className='bg-white  text-black  flex flex-col gap-[26px]'>
            ...
            <Header b1={<S_filter />} b2={<Refresh onClick={handleRefresh} loading={loading} />} title='Category Management' b3={<Add onClick={handleAddClick} />} desc="Organise your products with categories and manage your inventory" />
            <Cat_table />
                    ...
                    <div className="mt-8">
                        ...
                        <div className="space-y-4">
                            {categorie.filters?.map((f, index) => (
                                <div key={f.id || index} className="p-4 border rounded-lg bg-white shadow-sm">
