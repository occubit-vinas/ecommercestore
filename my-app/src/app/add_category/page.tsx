...
const CategoryForm = () => {
    ...
    const [newFilterType, setNewFilterType] = useState<"SELECT" | "MULTISELECT" | "INPUT" | string>("INPUT");
    ...
    const [newAttrType, setNewAttrType] = useState<"TEXT" | "NUMBER" | "SELECT" | string>("TEXT");
    ...
    const updateFormState = (field:string, value:string): void => {
        setFormState(prev => ({ ...prev, [field]: value }));
    };


    const getActiveFieldStyle = (fieldName:string): string => {
                                        ...
                                        >
                                            <SelectTrigger className="w-[404px] min-h-[52px] px-3 py-2 rounded-[16px] border border-[#4D4F5240] bg-white text-16-nm relative">
                                                ...
                                                <Image
                                                    ...
                                                    className={`absolute right-4 top-1/2 -translate-y-1/2 transition-transform duration-200 size-[22px]
                                    ...
                                    >
                                        <SelectTrigger className="min-h-[52px] w-[404px] px-3 py-2 rounded-[16px] border border-[#4D4F5240] text-16-nm relative">
                                            ...
                                            <Image
                                                ...
                                                className={`absolute right-4 top-1/2 -translate-y-1/2 transition-transform duration-200 size-[20px]
